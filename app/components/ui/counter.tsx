...
const Counter: React.FC<CounterProps> = ({ reduce, increase, count, onChange }) => {
  return (
    <div className='flex items-center'>
      ...
      <NumericFormat defaultValue={count} onChange={onChange} value={count} id='founders-count' className='flex h-8 text-center w-12 border border-zinc-200 text-zinc-700 bg-white px-1 text-sm outline-none' allowNegative={false} />
